                    ...
                    <div className={"min-h-[70vh] w-full"}>
                                    ...
                                    <ul className={"grid grid-cols-1 md:grid-col-2 gap-[1.75rem]"}>
                                        {
                                            Experience.items.map((item, index) => {
                                                return (
                                                    <li key={index} className={"bg-[#232329] h-[12rem] py-6 px-10 rounded-xl flex flex-col justify-center items-center md:items-start gap-1"}>
                                        ...
                                        return(
                                            <li key={index} className={"bg-[#232329]"}>
                                                <TooltipProvider delayDuration={100}>
                                                    <Tooltip>
                                                        <TooltipTrigger className={"w-full h-[10rem] bg-[#232329] rounded-xl flex justify-center items-center group"}>
                        ...
                        <TabsContent value={"aboutMe"} className={"w-full text-center md:text-left"}>
                            <div className={"flex flex-col gap-[2rem]"}>
                                ...
                                <p className={"max-w-[25rem] text-white/60 mx-auto md:mx-0"}>{AboutMe.description}</p>
                                <ul className={"grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-y-6 max-w-[39rem] mx-auto md:mx-0"}>
                                    {
